...
if len(result) == 1 and parser['APP_CONFIG'].get('AppConnected') == "true":
    ...
    db = firestore.Client()
    if len(parser["APP_CONFIG"].get("CameraID")) != 20:
        ...
        cam_document_template = {
            ...
            "addedOn": datetime_helpers.utcnow(),
    ...
    # Start wifi hotspot
    access_point = pyaccesspoint.AccessPoint(ssid=parser["APP_CONFIG"].get("H_SSID"), password=parser["APP_CONFIG"].get("H_PSK"))
    access_point.start()
    print(
